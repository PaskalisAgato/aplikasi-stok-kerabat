            ...
            <div className="p-6 space-y-8 overflow-y-auto pb-32">
                ...
                <div className="space-y-6">
                    ...
                    <div className="flex flex-col items-center gap-4 py-2">
                        ...
                        <p className="text-[10px] text-[var(--text-muted)] font-bold uppercase tracking-widest">Ganti Foto Profil</p>
                    </div>
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="relative group">
                            ...
                            <select 
                                ...
                                className="w-full bg-slate-100 border-none rounded-2xl pl-12 pr-4 py-3.5 focus:ring-2 focus:ring-primary/50 text-[var(--text-main)] text-sm font-medium appearance-none transition-all cursor-pointer"
                            >
                ...
                <div className="fixed bottom-0 left-0 right-0 p-6 bg-background-app/80 backdrop-blur-md border-t border-primary/10 max-w-md mx-auto">
                    <button className="w-full bg-gradient-to-r from-primary to-primary-dark text-[var(--text-main)] font-black py-4 rounded-2xl shadow-lg shadow-primary/25 hover:shadow-primary/35 transition-all active:scale-[0.98] flex items-center justify-center gap-2 text-sm uppercase tracking-widest">
