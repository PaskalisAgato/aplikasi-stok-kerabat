...
function App() {
    ...
    return (
        <Layout
            ...
            footer={
                <footer className="p-8 glass border-t dark:border-white/10 border-slate-200 shrink-0 shadow-[0_-20px_40px_rgba(0,0,0,0.5)]">
                    <div className="flex gap-6">
                        ...
                        <button className="flex-[3] py-5 bg-gradient-to-r from-primary to-amber-600 dark:text-white dark:text-white text-slate-900 font-black text-[10px] uppercase tracking-widest rounded-3xl shadow-2xl shadow-primary/40 hover:scale-[1.02] active:scale-95 transition-all flex items-center justify-center gap-4">
        ...
        >
            <div className="space-y-12">
                ...
                <section className="space-y-8 animate-in slide-in-from-top-4 duration-700">
                    <div className="flex items-center justify-between px-2">
                        <div className="space-y-1">
                            <h3 className="text-[10px] font-black uppercase tracking-[0.3em] dark:text-slate-400 dark:text-slate-400 text-slate-500 opacity-60">Komposisi</h3>
                            <p className="text-xl font-black font-display tracking-tight dark:text-white dark:text-white text-slate-900 uppercase">Bahan Baku</p>
                        </div>
                            ...
                            >
                                <div className="flex justify-between items-start mb-6 relative z-10">
                                    <div className="space-y-2">
                                        <h4 className="text-lg font-black font-display tracking-tight dark:text-white dark:text-white text-slate-900 uppercase leading-none truncate group-hover:text-primary transition-colors">{ing.name}</h4>
                                        <div className="flex items-center gap-2">
                                            <span className="material-symbols-outlined text-[10px] text-primary font-black">sell</span>
                                            <p className="text-[10px] dark:text-slate-400 dark:text-slate-400 text-slate-500 font-black uppercase tracking-widest opacity-60">
                                ...
                                <div className="flex items-center justify-between relative z-10">
                                    <div className="flex items-center gap-3 glass rounded-2xl p-1.5 dark:border-white/5 border-slate-200 shadow-inner">
                                        <button
                                        ...
                                        <div className="flex items-center gap-2 px-4">
                                            <input
                                                className="w-16 text-center bg-transparent border-none focus:ring-0 p-0 font-black text-xl dark:text-white dark:text-white text-slate-900 placeholder:opacity-20"
                                                type="number"
                                                value={ing.qty}
                                    ...
                                    <div className="text-right">
                                        <p className="text-[9px] font-black dark:text-slate-400 dark:text-slate-400 text-slate-500 uppercase tracking-widest opacity-40 mb-1">Subtotal Cost</p>
                    ...
                    {/* Overhead & Buffer */}
                    <div className="p-8 glass rounded-[2.5rem] dark:border-white/5 border-slate-200 space-y-6 relative overflow-hidden group">
                        <div className="flex items-center justify-between relative z-10">
                            <div className="flex items-center gap-4">
                                ...
                                <div className="space-y-1">
                                    <h3 className="text-sm font-black uppercase tracking-widest dark:text-white dark:text-white text-slate-900">Overhead & Buffer</h3>
                                    <p className="text-[9px] font-black dark:text-slate-400 dark:text-slate-400 text-slate-500 uppercase tracking-widest opacity-40">Biaya Tambahan (%)</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <p className="text-[9px] dark:text-slate-400 dark:text-slate-400 text-slate-500 font-black uppercase tracking-[0.2em] leading-relaxed opacity-60 text-center relative z-10">
                ...
                <section className="space-y-8 pb-10">
                    ...
                    <div className="card p-8 dark:border-white/5 border-slate-200 space-y-10 relative overflow-hidden group">
                        <div className="space-y-8 relative z-10">
                            {/* Selling Price */}
                            <div className="flex justify-between items-center group/item">
                                <div className="space-y-1">
                                    <span className="text-[10px] font-black uppercase tracking-widest dark:text-slate-400 dark:text-slate-400 text-slate-500 opacity-60">Harga Jual per Cup</span>
                                ...
                                <div className="flex items-center gap-3 border-b-4 border-primary/20 group-focus-within/item:border-primary/60 transition-all pb-2">
                                    ...
                                    <input
                                        className="bg-transparent border-none p-0 text-right font-black text-3xl focus:ring-0 w-32 dark:text-white dark:text-white text-slate-900 tracking-tight outline-none"
                                        type="text"
                            ...
                            {/* Total HPP */}
                            <div className="flex justify-between items-center px-4 py-4 glass rounded-2xl dark:border-white/5 border-slate-200">
                                <span className="text-[10px] font-black uppercase tracking-widest dark:text-slate-400 dark:text-slate-400 text-slate-500 opacity-60">Production Cost (HPP)</span>
                                <span className="text-lg font-black dark:text-white dark:text-white text-slate-900 font-display tracking-tight">{formatRp(totalHPP)}</span>
                            </div>
                            ...
                            <div className="p-8 glass rounded-[3rem] border-primary/10 shadow-3xl shadow-primary/10 flex items-center justify-between bg-gradient-to-br from-primary/10 to-transparent relative overflow-hidden">
                                ...
                                <div className="text-right space-y-2 relative z-10">
                                    <p className="text-[10px] font-black dark:text-slate-400 dark:text-slate-400 text-slate-500 uppercase tracking-widest opacity-60 mb-2">Profit per Unit</p>
                                    <p className="text-2xl font-black dark:text-white dark:text-white text-slate-900 font-display tracking-tight leading-none">{formatRp(laba)}</p>
                                </div>
