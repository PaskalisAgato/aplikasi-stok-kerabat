                ...
                <header className="sticky top-0 z-50 glass border-b border-white/5 px-8 py-6 flex items-center justify-between shadow-xl">
                    <div className="flex items-center gap-6">
                        ...
                        <div className="space-y-1">
                            <h1 className="text-2xl font-black font-display tracking-tight text-[var(--text-main)] uppercase leading-none">Edit Resep</h1>
                            <p className="text-[10px] font-black text-primary uppercase tracking-[0.4em] opacity-80 leading-tight">Recipe Engineering</p>
                        </div>
                    </div>
                    <button
                        className="glass px-6 py-2.5 rounded-xl text-[10px] font-black uppercase tracking-widest text-primary border-primary/20 hover:bg-primary/10 transition-all active:scale-95"
