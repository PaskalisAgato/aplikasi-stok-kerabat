    ...
    return (
        <nav className="fixed bottom-0 left-0 right-0 bg-background-app  border-t border-primary/20 px-4 pb-6 pt-2 z-30">
            <div className="flex justify-around items-center max-w-md mx-auto">
                <a className="flex flex-col items-center gap-1 text-[var(--text-muted)] " href={homeUrl}>
                    <span className="material-symbols-outlined">home</span>
                    <p className="text-[10px] font-medium uppercase tracking-tighter">Home</p>
                </a>
                <a className="flex flex-col items-center gap-1 text-[var(--text-muted)] " href={stokUrl}>
                ...
                <a className="flex flex-col items-center gap-1 text-[var(--text-muted)] " href={laporanUrl}>
