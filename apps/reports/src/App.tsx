            ...
            <div className="grid grid-cols-1 xl:grid-cols-2 gap-10 animate-in fade-in zoom-in duration-1000">
                ...
                <div className="space-y-8">
                    ...
                    <div className="lg:hidden grid grid-cols-2 gap-4 pb-20">
                        <button className="flex items-center justify-center gap-3 glass border-primary/40 text-primary font-black py-5 rounded-[1.5rem] active:scale-95 transition-all text-xs uppercase tracking-widest shadow-xl">
                            <span className="material-symbols-outlined">picture_as_pdf</span>
                            PDF
                        </button>
                        <button className="flex items-center justify-center gap-3 bg-emerald-500 text-slate-950 font-black py-5 rounded-[1.5rem] shadow-2xl shadow-emerald-500/30 active:scale-95 transition-all border-none text-xs uppercase tracking-widest">
