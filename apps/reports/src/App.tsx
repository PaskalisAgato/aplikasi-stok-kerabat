    ...
    return (
        ...
        >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
                {isLoading ? (
                    <div className="col-span-full h-48 flex flex-col items-center justify-center space-y-4">
                        <span className="material-symbols-outlined animate-spin text-primary text-6xl">refresh</span>
                        <p className="text-xs font-black text-muted uppercase tracking-widest">Menganalisis Data...</p>
                    </div>
                ) : (
                    <>
                        ...
                        <div className="card p-8 bg-[#d4823a] text-white border-transparent shadow-2xl shadow-[#d4823a]/30 relative overflow-hidden group">
                            ...
                            <p className="text-xs font-black text-white/70 uppercase tracking-[0.2em] mb-3">Profit Bersih (Net)</p>
