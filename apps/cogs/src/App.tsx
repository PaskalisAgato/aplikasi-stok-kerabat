            ...
            <div className="relative flex h-auto min-h-screen w-full flex-col max-w-md mx-auto shadow-2xl border-x border-slate-800/10 ">
                ...
                <main className="flex-1 overflow-y-auto pb-8">
                    ...
                    <div className="flex flex-col gap-3 px-4 pt-2 pb-6">
                        ...
                        <div className="flex flex-col gap-1.5 rounded-xl p-4 bg-primary/5  border border-primary/10  shadow-sm">
                            ...
                            <div className="flex items-center gap-1.5 mt-1">
                                ...
                                <p className="text-green-600  text-[11px] font-bold">+5.2% vs last mo</p>
                            </div>
                        </div>

                        <div className="flex flex-col gap-1.5 rounded-xl p-4 bg-primary/5  border border-primary/10  shadow-sm">
                            <p className="text-slate-500  text-xs font-semibold uppercase tracking-wider">Usage Volume</p>
                            <p className="text-slate-900  text-2xl font-extrabold leading-tight tracking-tight">35.4 kg</p>
                            <div className="flex items-center gap-1.5 mt-1">
                                <span className="material-symbols-outlined text-red-600  text-[16px]">trending_down</span>
                                <p className="text-red-600  text-[11px] font-bold">-2.1% vs last mo</p>
                            </div>
                        </div>

                        <div className="flex flex-col gap-1.5 rounded-xl p-4 bg-primary/5  border border-primary/10  shadow-sm">
                            <p className="text-slate-500  text-xs font-semibold uppercase tracking-wider">Waste Loss</p>
                            <p className="text-slate-900  text-2xl font-extrabold leading-tight tracking-tight">1.2 kg</p>
                            <div className="flex items-center gap-1.5 mt-1">
                                <span className="material-symbols-outlined text-green-600  text-[16px]">check_circle</span>
                                <p className="text-green-600  text-[11px] font-bold">Within tolerance (3.4%)</p>
                            </div>
                        </div>
                    ...
                    <div className="px-4 pb-6">
                        <h3 className="text-slate-900  text-base font-bold tracking-tight mb-3">Price Trend (3 Mo)</h3>

                        <div className="relative w-full h-48 bg-slate-50  rounded-2xl border border-primary/10 flex items-end justify-between p-5 pt-8 overflow-hidden shadow-inner group">
                            {/* Decorative Background Icon */}
                            <div className="absolute inset-0 flex items-center justify-center opacity-[0.03]  pointer-events-none transition-transform duration-700 group-hover:scale-110">
                                <span className="material-symbols-outlined text-[140px] text-slate-900 ">monitoring</span>
                            </div>

                            {/* Chart Bars */}
                            <div className="flex flex-col items-center gap-3 h-full justify-end w-1/3 z-10">
                                <div className="w-10 bg-primary/40  rounded-t-lg h-[60%] transition-all duration-500 hover:bg-primary/60"></div>
                            ...
                            <div className="flex flex-col items-center gap-3 h-full justify-end w-1/3 z-10 relative">
                                <div className="w-10 bg-primary/60  rounded-t-lg h-[75%] transition-all duration-500 hover:bg-primary/80"></div>
                            ...
                            <div className="flex flex-col items-center gap-3 h-full justify-end w-1/3 z-10 relative">
                                ...
                                <span className="text-xs text-slate-900  font-bold">Dec</span>
                            </div>
                        </div>
                    </div>
                    ...
                    {/* Usage breakdown */}
                    <div className="px-4 pb-6">
                        <h3 className="text-slate-900  text-base font-bold tracking-tight mb-3">Usage by Menu Item</h3>
                        <div className="flex flex-col gap-2.5">

                            <div className="flex items-center justify-between p-3.5 rounded-xl bg-slate-50  border border-slate-100  hover:border-primary/30 transition-colors">
                                <div className="flex flex-col gap-0.5">
                                    <p className="text-sm font-bold tracking-tight text-slate-900 ">Kopi O (Regular)</p>
                                    <p className="text-[11px] text-slate-500 font-medium">18g per serving</p>
                                </div>
                                <div className="text-right flex flex-col gap-0.5">
                                    <p className="text-sm font-bold text-slate-900 ">Rp 2.250</p>
                            ...
                            <div className="flex items-center justify-between p-3.5 rounded-xl bg-slate-50  border border-slate-100  hover:border-primary/30 transition-colors">
                                <div className="flex flex-col gap-0.5">
                                    <p className="text-sm font-bold tracking-tight text-slate-900 ">Kopi Tarik</p>
                                    <p className="text-[11px] text-slate-500 font-medium">22g per serving</p>
                                </div>
                                <div className="text-right flex flex-col gap-0.5">
                                    <p className="text-sm font-bold text-slate-900 ">Rp 2.750</p>
                            ...
                            <div className="flex items-center justify-between p-3.5 rounded-xl bg-slate-50  border border-slate-100  hover:border-primary/30 transition-colors">
                                <div className="flex flex-col gap-0.5">
                                    <p className="text-sm font-bold tracking-tight text-slate-900 ">Kopi C</p>
                                    <p className="text-[11px] text-slate-500 font-medium">20g per serving</p>
                                </div>
                                <div className="text-right flex flex-col gap-0.5">
                                    <p className="text-sm font-bold text-slate-900 ">Rp 2.500</p>
                    ...
                    <div className="px-4 pb-8">
                        <div className="flex items-center justify-between mb-4">
                            <h3 className="text-slate-900  text-base font-bold tracking-tight">Recent Purchases</h3>
                            ...
                            <table className="w-full text-left bg-white ">
                                ...
                                <tbody className="text-sm divide-y divide-slate-100 ">
                                    <tr className="hover:bg-slate-50  transition-colors">
                                        <td className="py-3.5 px-4 text-slate-600  font-medium">Dec 12</td>
                                        <td className="py-3.5 px-4 font-bold text-slate-900 ">Medan Coffee Co.</td>
                                        <td className="py-3.5 px-4 text-slate-600 ">10kg</td>
                                        <td className="py-3.5 px-4 text-right font-bold text-slate-900 ">Rp 126k</td>
                                    </tr>
                                    <tr className="hover:bg-slate-50  transition-colors">
                                        <td className="py-3.5 px-4 text-slate-600  font-medium">Dec 05</td>
                                        <td className="py-3.5 px-4 font-bold text-slate-900 ">Lokal Roasters</td>
                                        <td className="py-3.5 px-4 text-slate-600 ">15kg</td>
                                        <td className="py-3.5 px-4 text-right font-bold text-slate-900 ">Rp 124k</td>
                                    </tr>
                                    <tr className="hover:bg-slate-50  transition-colors">
                                        <td className="py-3.5 px-4 text-slate-600  font-medium">Nov 28</td>
                                        <td className="py-3.5 px-4 font-bold text-slate-900 ">Medan Coffee Co.</td>
                                        <td className="py-3.5 px-4 text-slate-600 ">10kg</td>
                                        <td className="py-3.5 px-4 text-right font-bold text-slate-900 ">Rp 125k</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
