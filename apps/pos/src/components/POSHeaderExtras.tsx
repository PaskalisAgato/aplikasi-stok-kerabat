                        ...
                        <div className={`absolute right-0 mt-3 w-64 ${PerformanceSettings.getGlassClass()} border border-[var(--border-dim)] rounded-2xl p-3 shadow-[var(--card-shadow)] z-50`}>
                            <div className="space-y-3">
                                ...
                                <div className="space-y-1">
                                    ...
                                    <button 
                                        onClick={() => { navigateTo('floor-plan'); setIsActionMenuOpen(false); }}
                                        className={`w-full px-4 py-2.5 rounded-xl flex items-center gap-3 ${view === 'floor-plan' ? 'bg-primary/20 text-primary font-black border border-primary/20' : 'text-[var(--text-muted)] hover:bg-white/5 font-bold'}`}
                                    >
                                        <span className="material-symbols-outlined text-base">table_restaurant</span>
                                        <span className="text-xs uppercase tracking-widest">Edit Denah Meja</span>
                                    </button>
                                </div>
