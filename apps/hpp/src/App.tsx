            ...
            {isLoading ? (
                ...
                <div className="space-y-10">
                    ...
                    <section className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 animate-in fade-in slide-in-from-top-4 duration-700">
                            ...
                            <div className="space-y-3">
                                ...
                                <div className="relative">
                                    ...
                                    <input 
                                        ...
                                        className="w-full bg-transparent border-none focus:ring-0 text-2xl font-black dark:text-white dark:text-white text-slate-900 pl-7 p-0 outline-none"
                                        placeholder="0"
                                    />
                                </div>
                            </div>
                        ...
                        <div className="card group p-6 flex flex-col justify-between hover:scale-[1.02] transition-transform duration-500 dark:border-white/5 border-slate-200">
                            <div className="space-y-1">
                                <p className="text-[10px] font-black text-primary uppercase tracking-[0.3em] opacity-60">Profit Per Cup</p>
                                <h2 className="text-3xl font-black dark:text-white dark:text-white text-slate-900 font-display tracking-tighter uppercase leading-tight">
                                    Rp {Math.max(0, sellingPrice - (totalHPPBahan / (hppData?.totalSalesCount || 1))).toLocaleString('id-ID', { maximumFractionDigits: 0 })}
                                </h2>
                            </div>
                            <div className="mt-4 pt-4 border-t dark:border-white/5 border-slate-200">
                                <span className="text-[8px] font-black dark:text-slate-400 dark:text-slate-400 text-slate-500 uppercase tracking-widest opacity-40 italic">Margin: {sellingPrice > 0 ? safeNumber(((sellingPrice - (totalHPPBahan / (hppData?.totalSalesCount || 1))) / sellingPrice) * 100).toFixed(1) : 0}%</span>
                            </div>
                        </div>
                        ...
                        <div className="card group p-6 flex flex-col justify-between hover:scale-[1.02] transition-transform duration-500 dark:border-white/5 border-slate-200">
                            <div className="space-y-1">
                                ...
                                <h2 className="text-3xl font-black dark:text-white dark:text-white text-slate-900 font-display tracking-tighter uppercase leading-tight">Rp {totalHPPBahan.toLocaleString('id-ID')}</h2>
                            </div>
                            <div className="mt-4 pt-4 border-t dark:border-white/5 border-slate-200">
                                <span className="text-[8px] font-black dark:text-slate-400 dark:text-slate-400 text-slate-500 uppercase tracking-widest opacity-40 italic">30 Hari Terakhir</span>
                            </div>
                        </div>
                        ...
                        <div className="card group p-6 flex flex-col justify-between hover:scale-[1.02] transition-transform duration-500 dark:border-white/5 border-slate-200">
                            <div className="space-y-1">
                                ...
                                <h2 className="text-3xl font-black dark:text-white dark:text-white text-slate-900 font-display tracking-tighter uppercase leading-tight">{ingredientsHPP.length} <span className="text-sm opacity-40 font-bold ml-1">SKU</span></h2>
                            </div>
                            <div className="mt-4 pt-4 border-t dark:border-white/5 border-slate-200 flex items-center gap-2">
                    ...
                    <section className="animate-in fade-in slide-in-from-bottom-4 duration-700">
                        <div className="flex items-center justify-between mb-6 px-2">
                            <div className="space-y-1">
                                <h3 className="text-[10px] font-black uppercase tracking-[0.3em] dark:text-slate-400 dark:text-slate-400 text-slate-500 opacity-60">Tren Pengeluaran</h3>
                            ...
                            <span className="text-[9px] dark:text-slate-400 dark:text-slate-400 text-slate-500 font-black tracking-widest uppercase dark:bg-white/5 bg-white shadow-sm border border-slate-200 px-4 py-2 rounded-full border dark:border-white/10 border-slate-200 shadow-inner">
                                Avg: Rp {(totalHPPBahan / 30).toLocaleString('id-ID', { maximumFractionDigits: 0 })}/hari
                            </span>
                        </div>
                        <div className="card p-8 group overflow-hidden dark:border-white/5 border-slate-200">
                            ...
                            <div className="flex justify-between mt-8 text-[8px] font-black dark:text-slate-400 dark:text-slate-400 text-slate-500 uppercase tracking-[0.3em] opacity-40 px-2">
                    ...
                    <section className="animate-in fade-in zoom-in duration-1000">
                        <div className="space-y-1 mb-6 px-2">
                            <h3 className="text-[10px] font-black uppercase tracking-[0.3em] dark:text-slate-400 dark:text-slate-400 text-slate-500 opacity-60">Kontribusi Biaya</h3>
                            <p className="text-xl font-black font-display tracking-tight dark:text-white dark:text-white text-slate-900 uppercase">Bahan Termahal (Usage)</p>
                        </div>
                        ...
                        <div className="grid grid-cols-1 gap-4">
                            {ingredientsHPP.length === 0 ? (
                                <div className="flex flex-col items-center justify-center py-20 glass rounded-[3rem] opacity-40 border-dashed border-2">
                                    ...
                                    <p className="font-black text-xs uppercase tracking-widest dark:text-white dark:text-white text-slate-900">Data Kosong</p>
                                ...
                                ingredientsHPP.map((ing: any) => (
                                    <div key={ing.id} className="card group p-4 sm:p-5 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-6 hover:scale-[1.01] active:scale-[0.99] transition-all dark:border-white/5 border-slate-200">
                                        <div className="flex items-center gap-4 sm:gap-5 w-full sm:w-auto">
                                            ...
                                            <div className="flex-1 min-w-0">
                                                <h3 className="text-base sm:text-lg font-black font-display tracking-tight dark:text-white dark:text-white text-slate-900 uppercase leading-tight line-clamp-2">{ing.name}</h3>
                                                <p className="text-[9px] sm:text-[10px] dark:text-slate-400 dark:text-slate-400 text-slate-500 font-bold uppercase tracking-widest opacity-60 mt-0.5">{safeNumber(ing.totalQty).toFixed(2)} unit digunakan</p>
                                            </div>
                                        </div>
                                        <div className="text-left sm:text-right shrink-0 space-y-1 w-full sm:w-auto pl-16 sm:pl-0">
                                            ...
                                            <div className="flex items-center justify-start sm:justify-end gap-1.5">
                                                ...
                                                <div className="w-16 sm:w-12 dark:bg-white/5 bg-white shadow-sm border border-slate-200 h-1 rounded-full overflow-hidden">
                        ...
                        <div className="card p-8 bg-primary/5 hover:bg-primary/10 transition-all border-primary/10 group overflow-hidden relative">
                            ...
                            <div className="flex gap-6 items-start relative z-10">
                                ...
                                <div className="space-y-4">
                                    <h3 className="text-lg font-black font-display tracking-tight dark:text-white dark:text-white text-slate-900 uppercase">Metodologi Perhitungan</h3>
