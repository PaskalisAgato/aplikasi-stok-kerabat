    ...
    const content = (
        <div className={`w-full ${isStandalone ? 'max-w-7xl mx-auto px-6 pb-20' : 'px-6 pb-20'}`}>
            ...
            <button
                ...
                className="fixed bottom-6 right-6 sm:bottom-10 sm:right-10 size-16 sm:size-24 accent-gradient text-[var(--text-main)] rounded-[2rem] sm:rounded-[2.5rem] shadow-[0_20px_50px_rgba(200,100,20,0.4)] flex items-center justify-center active:scale-75 transition-all hover:scale-110 z-[100]"
            >
