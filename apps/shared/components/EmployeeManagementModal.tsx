...
const EmployeeManagementModal: React.FC<EmployeeManagementModalProps> = ({ isOpen, onClose, isStandalone }) => {
        ...
        <div className={`w-full ${isStandalone ? 'max-w-7xl mx-auto px-6 pb-20' : 'px-6 pb-20'}`}>
            ...
            <div className="py-10 animate-in fade-in slide-in-from-top-4 duration-700">
                <div className="relative group max-w-2xl">
                    ...
                    <input
                        className="block w-full pl-14 pr-6 py-5 glass border-none rounded-[2rem] focus:ring-4 focus:ring-primary/20 dark:text-white dark:text-white text-slate-900 placeholder:dark:text-slate-400 dark:text-slate-400 text-slate-500 text-base font-bold shadow-inner"
            ...
            <div className="space-y-8 animate-in fade-in zoom-in duration-1000">
                <div className="flex items-center justify-between px-2">
                    <h2 className="text-[10px] font-black uppercase tracking-[0.3em] dark:text-slate-400 dark:text-slate-400 text-slate-500 opacity-60">Daftar Karyawan</h2>
                    <div className="glass px-4 py-1.5 rounded-full dark:border-white/5 border-slate-200 shadow-inner">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
                            ...
                            >
                                <div className="relative z-10">
                                    <div className="relative">
                                        <div className={`size-24 rounded-[2rem] flex items-center justify-center overflow-hidden border-4 bg-[var(--bg-app)] dark:border-white/10 border-slate-200 shadow-2xl transition-transform group-hover:rotate-3`}>
                                            {employee.image ? (
                                                <img 
                                ...
                                <div className="relative z-10 space-y-2 flex-1 w-full">
                                    <h3 className="text-xl font-black font-display tracking-tight dark:text-white dark:text-white text-slate-900 uppercase truncate group-hover:text-primary transition-colors">{employee.name}</h3>
                                ...
                                <div className="pt-4 border-t dark:border-white/5 border-slate-200 w-full flex items-center justify-center gap-2 opacity-40 group-hover:opacity-100 transition-opacity">
                                    <p className="text-[8px] font-black uppercase tracking-widest dark:text-slate-400 dark:text-slate-400 text-slate-500 group-hover:text-primary transition-colors">Lihat Detail Karyawan</p>
                        ...
                        {filteredEmployees.length === 0 && (
                            <div className="col-span-full flex flex-col items-center justify-center py-32 glass rounded-[3rem] opacity-40 border-dashed border-2">
                                ...
                                <p className="font-black text-lg uppercase tracking-widest dark:text-white dark:text-white text-slate-900">Karyawan Tidak Ditemukan</p>
            ...
            <button
                ...
                className="fixed bottom-6 right-6 sm:bottom-10 sm:right-10 size-16 sm:size-24 accent-gradient dark:text-white dark:text-white text-slate-900 rounded-[2rem] sm:rounded-[2.5rem] shadow-[0_20px_50px_rgba(200,100,20,0.4)] flex items-center justify-center active:scale-75 transition-all hover:scale-110 z-[100]"
            >
    ...
    return (
        <div className="fixed inset-0 z-[60] flex flex-col bg-[var(--bg-app)] dark:text-white dark:text-white text-slate-900 antialiased animate-in fade-in duration-500 overflow-hidden">
            {/* Header for Modal usage */}
            <header className="z-50 flex items-center glass border-b dark:border-white/5 border-slate-200 p-6 shrink-0">
                <div className="flex items-center gap-6 max-w-7xl mx-auto w-full">
                    ...
                    <div className="space-y-1">
                        <h1 className="text-2xl font-black font-display tracking-tight dark:text-white dark:text-white text-slate-900 uppercase">Kelola Karyawan</h1>
