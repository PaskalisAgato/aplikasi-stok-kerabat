    ...
    return (
        ...
        <div className="fixed inset-0 z-50 flex flex-col justify-end bg-black/60 backdrop-blur-sm">
            ...
            <div className="w-full bg-background-light  rounded-t-xl shadow-2xl flex flex-col max-h-[92vh] border-t border-primary/20">
                ...
                <div className="flex-1 overflow-y-auto">
                        ...
                        <div className="flex w-full flex-col gap-4 sm:flex-row sm:justify-between items-start">
                            <div className="flex gap-4 items-center">
                                ...
                                <div className="flex flex-col">
                                    <h1 className="text-slate-900  text-2xl font-bold leading-tight">{selectedItem?.name || 'Item Name'}</h1>
                                    ...
                                    <p className="text-slate-500  text-sm">Update terakhir: {new Date(selectedItem?.updatedAt || Date.now()).toLocaleDateString('id-ID')}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="px-4 py-4 mt-2">
                        <div className="flex items-center justify-between mb-4">
                            <h3 className="text-slate-900  text-lg font-bold tracking-tight">Riwayat Stok</h3>
                ...
                <div className="p-4 flex gap-3 sticky bottom-0 bg-background-light  border-t border-slate-200 ">
                    ...
                    <button 
                        onClick={onEditClick}
                        className="flex h-auto px-4 items-center justify-center bg-slate-100  text-slate-900  rounded-lg border border-slate-200  hover:bg-slate-200  transition-colors"
                ...
                <div className="h-6 bg-background-light " />
            </div>
        </div>
    );
};
