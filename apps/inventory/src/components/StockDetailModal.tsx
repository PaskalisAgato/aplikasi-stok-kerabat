    ...
    return (
        ...
        <div className="fixed inset-0 z-50 flex flex-col justify-end bg-black/60 backdrop-blur-sm">
            ...
            <div className="w-full bg-background-app  rounded-t-xl shadow-2xl flex flex-col max-h-[92vh] border-t border-border-dim">
                ...
                <div className="flex-1 overflow-y-auto">
                        ...
                        <div className="flex w-full flex-col gap-4 sm:flex-row sm:justify-between items-start">
                            <div className="flex gap-4 items-center">
                                ...
                                <div className="flex flex-col">
                                    ...
                                    <p className="text-muted text-sm">Update terakhir: {new Date(selectedItem?.updatedAt || Date.now()).toLocaleDateString('id-ID')}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="px-4 py-4 mt-2">
                        <div className="flex items-center justify-between mb-4">
                            <h3 className="text-main text-lg font-bold tracking-tight">Riwayat Stok</h3>
                                ...
                                movements.map((m) => (
                                    <div key={m.id} className="flex items-start gap-3">
                                        ...
                                        <div className="flex-1 border-b border-border-dim pb-3">
                                            ...
                                            {m.reason && <p className="text-[10px] italic text-muted mt-1">{m.reason}</p>}
                                        </div>
                                    </div>
                                ))
                            ) : (
                ...
                <div className="h-6 bg-background-app" />
            </div>
        </div>
    );
};
