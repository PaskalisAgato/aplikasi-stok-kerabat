            ...
            <main className="flex-1 max-w-md mx-auto w-full pb-32">
                ...
                <div className="flex flex-col items-center p-6">
                    <div className="relative group">
                        ...
                        ></div>
                        <button className="absolute bottom-0 right-0 bg-primary text-white p-2 rounded-full shadow-lg hover:scale-105 active:scale-95 transition-transform border-2 border-background-app">
                            <span className="material-symbols-outlined text-sm font-bold">photo_camera</span>
                        </button>
                    </div>
                    <button className="mt-4 text-primary font-bold text-sm hover:opacity-80 transition-opacity">
                        Ubah Foto Profil
                    </button>
                </div>
                ...
                <div className="px-4 space-y-6">
                    ...
                    {/* Nomor WhatsApp */}
                    <div>
                        <label className="block mb-2 text-sm font-bold text-muted uppercase">Nomor WhatsApp</label>
                        <div className="relative">
                            <span className="absolute left-4 top-1/2 -translate-y-1/2 text-muted font-bold">+62</span>
                            <input
                                className="w-full h-14 rounded-xl border border-border-dim bg-background-app text-main focus:ring-primary focus:border-primary transition-all pl-14 pr-4"
                                type="tel"
                    ...
                    {/* Status Akun */}
                    <div className="flex items-center justify-between p-4 rounded-xl bg-surface border border-border-dim">
                        <div className="flex flex-col">
                            <span className="font-bold text-main">Status Akun</span>
                            <span className="text-xs text-muted mt-0.5 font-semibold">Tentukan status akses aplikasi</span>
                        </div>
                        <label className="relative inline-flex items-center cursor-pointer">
                            ...
                            />
                            <div className="w-12 h-6 bg-background-app border border-border-dim peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-primary"></div>
                            <span className="ml-3 text-sm font-bold text-primary">{isActive ? 'Aktif' : 'Nonaktif'}</span>
                        </label>
                    </div>
                    ...
                    <div className="pt-8 pb-4 space-y-4">
                        ...
                        <button className="w-full h-14 flex items-center justify-center gap-2 text-red-500 font-bold rounded-xl border border-red-500/20 hover:bg-red-500/10 transition-colors active:scale-[0.98]">
