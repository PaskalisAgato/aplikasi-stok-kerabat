...
// GET all containers
containersRouter.get('/', requireAuth, async (req, res) => {
    try {
...
containersRouter.get('/:id', requireAuth, async (req, res) => {
    try {
...
containersRouter.post('/', requireAdmin, async (req, res) => {
    try {
...
containersRouter.put('/:id', requireAdmin, async (req, res) => {
    try {
        const id = parseInt(req.params.id);
...
containersRouter.delete('/:id', requireAdmin, async (req, res) => {
    try {
        const id = parseInt(req.params.id);
