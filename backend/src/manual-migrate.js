...
async function migrate() {
    ...
    try {
        ...
        try {
            ...
            console.log('vendor exists or error:', e.message);
        }
        try {
            ...
            console.log('external_receipt_url exists or error:', e.message);
        }
        try {
            ...
            console.log('fund_source exists or error:', e.message);
        }
        console.log('Done!');
    }
    catch (e) {
